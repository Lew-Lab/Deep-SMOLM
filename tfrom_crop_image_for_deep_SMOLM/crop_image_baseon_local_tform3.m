...
load(strcat('E:\Experimental_data\20220530 amyloid fibril\','\processed data8 data9_16\saved_beads_loc_for_tform_v3\tformx2y_y_center_505_200_FoV_250'));
...
%count = count+1;
range = round(-(FoV_each-1)/2)+1:1:round((FoV_each-1)/2);
SMLM_save_Nmae = ['processed data9 data9_16\data',num2str(dataN),'_centerY_y',num2str(ROI_centerY(1)),'_x_',num2str(ROI_centerY(2)),'_','FoV',num2str(FoV(1)),'_',num2str(FoV(2)),'_',num2str(ii),'th_FoV','.tif'];
